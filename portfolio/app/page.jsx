...
const Home = () => {
    ...
    return (
        <main id="backgroundImage" className="grid grid-cols-2 min-h-screen w-screen bg-[#030204] home">
            <div className='flex flex-col mb-20'>
                <div className="w-2/3 ml-12 mt-12 text-5xl text-zinc-100 justify-center" style={{ fontFamily: 'museoBold' }}>
                    <button className='hover:translate-x-6 hover:font-bold transition-all duration-300 ease-in-out'>SKILLS</button>
                    <br></br>
                    <button className='hover:translate-x-6 hover:font-bold transition-all duration-300 ease-in-out'>PROJECTS</button>
                    <br></br>
                    <button className='hover:translate-x-6 hover:font-bold transition-all duration-300 ease-in-out'>EXPERIENCE</button>
                </div>
